...
class SSIMSceneDetect(Singleton):
    ...
    def detect_and_extract(
        ...
        self._save_frame(prev_frame, frame_count, 1.0, scene_frames, output_folder)
        ...
        while True:
            ...
            if ssim_score < threshold:
                self._save_frame(curr_frame, frame_count, ssim_score, scene_frames, output_folder)
    ...
    def _save_frame(
        ...
        Args:
            ...
            output_folder: Folder to save the frame
        """
